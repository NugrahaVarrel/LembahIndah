            ...
            <div class="menu" style="float:left">
                <ul>
                    ...
                    <li><a href="">Category</a>
                        <ul class="dropdown">
                            <li><a href="<?php echo "kategori.php?kategori=tenda" ?>">Tenda</a></li>
                            <li><a href="<?php echo "kategori.php?kategori=memasak" ?>">Memasak</a></li>
                            <li><a href="<?php echo "kategori.php?kategori=pencahayaan" ?>">Pencahayan</a></li>
                            <li><a href="<?php echo "kategori.php?kategori=makanan" ?>">Makanan</a></li>
                        </ul>
                    </li>
